...
export class DataError extends AppError {
  ...
  /**
   * Attaches or merges extra context to the error, returning a new DataError instance.
   *
   ...
   * @returns Whether the error is a DataError
   */
  ...
  /**
   * Creates a DataError from an unknown value, preserving structure and context.
   *
...
export class ValidationError extends DataError {
  ...
  /**
   * Attaches or merges extra context to the error, returning a new ValidationError instance.
   *
   * @param extra - Additional context to merge
...
export class TransformationError extends DataError {
  ...
  /**
   * Attaches or merges extra context to the error, returning a new TransformationError instance.
   *
   * @param extra - Additional context to merge
